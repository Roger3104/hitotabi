...
$(document).ready(function () {
  function PageTopCheck(){
      ...
      var secondTop =  $("#bottom").offset().top - 150; //#bottomの上から150pxの位置まで来たら
  ...
  $('.scroll-top a').click(function () {
    ...
    if (elmHash == "#bottom") {//もし、リンク先のhref の後が#bottomの場合
      var pos = $(elmHash).offset().top;
      $('body,html').animate({scrollTop: pos}, pos); //#bottomにスクロール
    }else{
